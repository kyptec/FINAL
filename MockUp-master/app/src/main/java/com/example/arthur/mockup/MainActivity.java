...
//        RecyclerView recyclerView;
        ...
        try {
            ...
            URL url = new URL("http://alphabits.weebly.com/"); //http://alphabits.weebly.com/ pacelosangeles
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        {
            case 0:
                objFragment = new menu_1.PlaceholderFragment();
                if(firstOpen == false) recyclerView.setVisibility(View.GONE);
                break;
            case 1:
                objFragment = new menu_2.PlaceholderFragment();
                recyclerView.setVisibility(View.VISIBLE);
                firstOpen = false;
                break;
            case 2:
                objFragment = new menu_3.PlaceholderFragment();
    ...
    public void Notifications ()
    {
        ...
        // set notify date (year, month 0-11, day, hours, mins, secs)
        cal.set(2014, 11, 7, 20, 22, 0);
